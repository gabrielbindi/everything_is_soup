...
URL_CONFIG="https://raw.githubusercontent.com/gabrielbindi/everything_is_soup/shell/soup.config"
command curl -sSL "$URL_CONFIG" -o "$TARGET_DIR/soup.config"
URL_LAZYGIT="https://raw.githubusercontent.com/gabrielbindi/everything_is_soup/shell/plugins/lazygit.sh"
